...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        CajaCliente1 cc = new CajaCliente1();
        cc.setVisible(true);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        int l = 0;//cd.buscarDeudor(Integer.parseInt(jLabel1.getText()));
        if (l > 0) {
            ClienteDeud cd1 = new ClienteDeud();
            cd1.setVisible(true);
        } else {
            alquilar();
        }
    ...
    public void alquilar() {
        ...
        try {
            ...
            cd.setDni(mp.getId_cliente());
            cd.setNombre(mp.getNombrecliente());
            cd1.setDni(mp.getId_cliente());
            cd.buscarDeudor();
